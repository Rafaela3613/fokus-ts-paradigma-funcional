...
const selecionarTarefa = (estado, tarefa) => {
  return Object.assign(Object.assign({}, estado), {
...
const atualizarUI = () => {
  ...
  const labelTarefaAtiva = document.querySelector(
    ".app__section-active-task-description"
  );
  const btnCancelar = document.querySelector(
    ".app__form-footer__button--cancel"
  );
  const btnDeletar = document.querySelector(
    ".app__form-footer__button--delete"
  );
  const btnDeletarConcluidas = document.querySelector(
  ...
  btnAdicionarTarefa.onclick = () => {
    formAdicionarTarefa === null || formAdicionarTarefa === void 0
      ? void 0
  ...
  estadoInicial.tarefas.forEach((tarefa) => {
    ...
    ulTarefas === null || ulTarefas === void 0
      ? void 0
